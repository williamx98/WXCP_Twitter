# Project 5 - WXCP_Twitter

WXCP_Twitter is a basic twitter app to read and compose tweets the [Twitter API](https://apps.twitter.com/).
...
The following **stretch** features are implemented:
- [x] Profile view should include that user's timeline (2pts)
...
- [x] User can reply to any tweet, and replies should be prefixed with the username and the reply_id should be set when posting the tweet (2pt)
